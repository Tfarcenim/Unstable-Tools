...
public class ReiClientPlugin implements REIClientPlugin {
    ...
    public void registerDisplays(DisplayRegistry registry) {
        ...
        UnstableToolsForge.instance.manager.getConversionMap().entrySet().stream().sorted(Comparator.comparing(b -> BuiltInRegistries.BLOCK.getKey(b.getKey()))).forEach(set -> {
