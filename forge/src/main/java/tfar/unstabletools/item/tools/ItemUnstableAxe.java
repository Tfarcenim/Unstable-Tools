  ...
  public boolean onLeftClickEntity(ItemStack stack, Player player, Entity entity) {
    if (entity instanceof LivingEntity) {
      ...
      if (livingEntity.getMobType() == MobType.UNDEAD)
        entity.hurt(player.damageSources().playerAttack(player), UnstableToolsForge.UNSTABLE.getAttackDamageBonus());
      else livingEntity.heal(UnstableToolsForge.UNSTABLE.getAttackDamageBonus());
